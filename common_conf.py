...
if __name__ == "__main__":
    ...
    print("----------------------------------------")
    this_file_path = os.path.dirname(os.path.abspath(__file__))
    print("root_dir={}".format(ConfMgr.get_root_path()))
    ConfMgr.set_root_path(this_file_path + "/example")
    print("root_dir={}".format(ConfMgr.get_root_path()))
    print("conf_dict={}".format(ConfMgr.parse_conf("example_conf_file.conf")))
    print("value_str={}".format(ConfMgr.get_value_str("example_conf_file.conf", "section_name", "key_name")))
    print("value_int={}".format(ConfMgr.get_value_int("example_conf_file.conf", "section_name", "key_name")))
    print("value_float={}".format(ConfMgr.get_value_float("example_conf_file.conf", "section_name", "key_name")))
    ...
    this_file_path = os.path.dirname(os.path.abspath(__file__))
    ConfMgr.set_root_path(this_file_path + "/example")
    GlobalConf.set_conf("conf_name3", ConfMgr.parse_conf("example_conf_file.conf"))
